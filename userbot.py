...
spam_posts = [RandomPost(TextPost("Да восторжествует справедливость! Только вперед! Ни шагу назад!"), TextPost("Мы сверхдержава! Кузница героев! За нами победа! С нами Бог!"))]
